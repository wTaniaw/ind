    ...
    <header class="navbar " >
        ...
        <div class="navbar-inner" >
            <div class="container" >
                ...
                <div class="nav-collapse collapse pull-left" style="padding-left:220px" >
                    <ul class="nav">
                    <li><a href="index.php">Inicio</a></li>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Aspirantes <i class="icon-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="RegistroExteriorAspirantes.php">Registrar aspirante</a></li>
                            </ul>
                        </li>
