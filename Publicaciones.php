...
function TablaBanner()
{
  ...
  $("#tablabanner").load("tablabanner.php");
}
    ...
    Cargando();
            ...
            $.ajax({
                ...
                success: function(datos)
                {
                  ...
                  {
                    MensajeB("La fotografía se guardó correctamente"+datos);
                    TablaBanner();
                    CerrarLoader();
...
{
  Cargando();
  $.post("Guardar.php?metodo=CerrarBanner&banner_id="+id,function(data){
    ValidarGuardado(data,"El banner se cerró correctamente", "Ocurrió un error al cerrar el banner");
    TablaBanner();
    CerrarLoader();
    $("#botoncerrarbanner").fadeOut();
  });
}
function ActivarBanner(id)
{
  Cargando();
  $.post("Guardar.php?metodo=ActivarBanner&banner_id="+id,function(data){
    ValidarGuardado(data,"El banner se activo correctamente", "Ocurrió un error al activar el banner");
    TablaBanner();
    CerrarLoader();
    $("#botonactivarbanner").fadeOut();
  });
}
