...
$administrativo=ConsultarRegistro("Select Administrativos.*,u.Nombre as NombreUsuario from Administrativos join Usuarios u on u.id=Administrativos.Usuario_id where Usuario_id=$usuario_id");
 ?>
...
<table class="hovered cell-hovered bordered sombra table">
            ...
            $.ajax({
                ...
                success: function(datos)
                {
                  ...
                  else
                  {
                    ...
                    window.location="Escolares.php?pagina=cuenta";
                  }
 ...
 <form method="post" id="formulario" enctype="multipart/form-data">
	...
	<tr>
		<td colspan="2"><?php echo $administrativo['Nombre']; ?> <?php echo $administrativo['ApellidoP']; ?> <?php echo $administrativo['ApellidoM']; ?></td>
	</tr>
	<tr>
		<th>Usuario</th>
		<th>Correo</th>
	...
	<tr>
		<td><?php echo $administrativo['NombreUsuario']?></td>
		<td><?php echo $administrativo['Correo']?></td>
	</tr>
	<tr>
<td colspan="2">
