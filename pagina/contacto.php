...
<script>
    $(document).ready(function() {
        ...
        function showSlides() {
            ...
            actualizador = setInterval(showSlides, 10000);
            slideIndex++;
        ...
        var actualizador = setInterval(showSlides, 10000); // Cambia de slide cada 3 segundos
    });
</script>
<style>
    ...
    .slide img {
        max-height: 200px;
        /* Altura máxima de la imagen según tu preferencia */
        margin: 0 auto;
        display: block;
    }
