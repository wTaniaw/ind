...
<div class="divsection">
    <div class="row section">
        <div class="col m6 s12  left-align">
            ...
            <div class="amber darken-4 white-text center-align col m12 s12 z-depth-5 waves-effect waves-light modal-trigger" onclick="$('#formcontacto').submit()" style="padding:10px;border-radius:10px"><h6>Enviar</h6></div>
        </div>
