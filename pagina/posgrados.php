...
<div class="divsection">
    <div class="row section">
        <div class="col m6 s12 p-3">
            <img src="img/docencia.png" width="90%">
        </div>
        <div class="col m6 s12 p-3">
            <h4>
                <b>Maestría en<br>
                    <span class="amber-text">Docencia</span>
                </b>
                <br><br>
...
<div class="divsection blue lighten-5">
    <div class="row section ">
        <div class="col m6 s12 p-3">
            <h4>
                <b>Maestría en<br>
                    <span class="amber-text">Psicología educativa</span>
                </b>
                <br><br>
                <div style="display:flex;justify-content: left;">
                    <h5 class="valign-wrapper"> <img src="img/cursar-maestria.png" width="50px" style="margin-right:10px"><u style="margin-right: 10px;">¿Quién puede cursar la maestría?</u> </h5>
...
<div class="divsection">
    <div class="row section">
        <div class="col m6 s12 p-3">
            <img src="img/politicas-publicas.png" width="90%">
        </div>
        <div class="col m6 s12 p-3">
            <h4>
                <b>Maestría en<br>
                    <span class="amber-text">Gestión de políticas públicas</span>
                </b>
                <br><br>
                <div style="display:flex;justify-content: left;">
                    <h5 class="valign-wrapper"> <img src="img/cursar-maestria.png" width="50px" style="margin-right:10px"><u style="margin-right: 10px;">¿Quién puede cursar la maestría?</u> </h5>
