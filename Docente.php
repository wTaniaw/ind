    ...
    <body>
        <header class="app-bar fixed-top" data-role="appbar">
            <div class="container">
                ...
                <a class="app-bar-element" href="Docente.php">Inicio</a>
                    ...
                    <div class="app-bar-drop-container bg-white fg-dark place-right" data-role="dropdown" data-no-close="true" style="display: none;">
                        <div class="padding20" style="width:200px">
                                ...
                                <center><img src="fotos/<?php echo $usuario_id.'.jpg' ?>" width="120px" height="120px" onerror="this.src='/img/Administrator.png';">
                                    <br><h5 class="text-light"><?php echo $docente ?></h5>
                                </center>

                                      <center >
                                    <a class="button danger" href="cerrarsesion.php">Salir</a>
                                      </center>
                        </div>
                    </div>
                </div>
        ...
        <div class="container page-content">
            ...
            <ul class="sidebar bg-dark compact left-side fixed-left" id="sidebar-2" style="opacity: 1; display: block; left: 0px;position:fixed;border:7px solid #1D1D1D;">
                <li><a href="javascript:Abrir('MiCuentaProfesor.php')" class="menun">
                        <span class="mif-user mif-ani-hover-shuttle icon mif-ani-fast"></span>
                        <span class="title">Mi Perfil</span>
                        <span class="counter"></span>
                    </a></li>
                <li><a href="javascript:Abrir('Calificaciones.php')" class="menun">
                        <span class="mif-user-check mif-ani-hover-shuttle icon mif-ani-fast"></span>
                        <span class="title">Calificaciones</span>
                        <span class="counter"></span>
                    </a></li>
                <li><a href="javascript:Abrir('Asistencias.php')" class="menun">
                        <span class="mif-list-numbered mif-ani-hover-shuttle icon mif-ani-fast"></span>
...
<div class="presenter sombra" data-role="presenter" data-height="300" data-easing="swing" data-duration="200" data-timeout="200" data-scene-timeout="6000">
      <div class="scene">
<?php
  ...
  while($publi=mysql_fetch_array($listpublicaciones))
{
  ?>
          <div class="act <?php echo $publi['ColorFondo']; ?> fg-white">
              ...
              <center><h1 class="actor" data-position="20,300" data-effect="random"><?php echo $publi['Titulo']; ?></h1></center>
              <p class="actor" style="text-align: left" data-position="100,300" data-effect="random"><?php echo $publi['Texto']; ?></p>
              <?php
